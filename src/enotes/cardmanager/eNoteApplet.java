...
public class eNoteApplet extends javacard.framework.Applet
{
    ...
    final static   short  PIN_TRY_LIMIT = 5;
    final     static   short  PIN_SIZE = 4;
    private   byte           m_ramArray[] = null;
     private   byte           m_PIN[] = new byte[4];
    ...
    void SetPIN(APDU apdu) {
      ...
      //store PIN in EEPROM m_pinArray
       m_PIN = new byte[dataLen];
       Util.arrayFillNonAtomic(m_PIN, (short) 0, dataLen, (byte) 0);
       Util.arrayCopyNonAtomic(apdubuf, ISO7816.OFFSET_CDATA, m_PIN, (short) 0,dataLen);
